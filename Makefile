...
CFLAGS=$(OPT) $(DEBUG) -Wall -Wno-pointer-sign -Wno-char-subscripts -fno-omit-frame-pointer -fvisibility=hidden -DENABLE_CRASH_HANDLER $(SDL_CFLAGS) -I$(SDL_PREFIX)/include
